...
const CreateCallScreen: React.FC<NavigationProps<'CreateCall'>> = ({ navigation }) => {
  const [isLoading, setIsLoading] = useState(false);
  const { createCall, initLocalStream } = useWebRTCContext();
  ...
  const handleCreateCall = async () => {
    try {
      ...
      (navigation as any).replace('Call', { callId: newCallId, isCaller: true });
    } catch (error) {
